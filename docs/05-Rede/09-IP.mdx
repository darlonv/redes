...
O IP foi especificado na [RFC 791](https://datatracker.ietf.org/doc/html/rfc791) <Bib bib='rfc_791_site'/>.
...
<Bib bib='rfc_791_site' type='abnt' link={true}/>


**Outros materiais**  

[RFC 791](https://datatracker.ietf.org/doc/html/rfc791)  
[BAKNI, M. Data packet of IPv4. Wikimedia Commons, 2022](https://commons.wikimedia.org/wiki/File:IPv4_Packet-en.svg)
